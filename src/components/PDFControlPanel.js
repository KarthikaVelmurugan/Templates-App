...
const ControlPanel = (props) => {
  ...
  return (
    <div className="control-panel mb-2 p-3 w-full d-flex align-items-baseline justify-content-between">
      <div className="d-flex  justify-content-between align-items-baseline text-center">
        <i
        ...
        <span>
          ...
          <input
            ...
            min={1}
            max={numPages || 1}
            className="p-0 pl-1 mx-2 border-2 border-gray-500 rounded-md"
            value={pageNumber}
